...
<div class="bg-white dark:bg-slate-800 rounded-2xl shadow-xl shadow-slate-200/50 dark:shadow-slate-900/50 border border-slate-100 dark:border-slate-700 p-8 max-w-3xl mx-auto transition-all duration-300">
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-slate-800 dark:text-white tracking-tight">Edit Mahasiswa</h1>
        <p class="text-slate-500 dark:text-slate-400 mt-2">Perbarui data mahasiswa sesuai dengan informasi terbaru.</p>
    </div>
