...
class MahasiswaSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($data as $row) {
            Mahasiswa::firstOrCreate(['nim' => $row['nim']], $row);
        }
    }
}
